...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_dlm_slope");
    reader.add_event(77, 75, "end", "model_dlm_slope");
    return reader;
}
#include <stan_meta_header.hpp>
class model_dlm_slope
  : public stan::model::model_base_crtp<model_dlm_slope> {
private:
        int N;
        int n_pos;
        vector_d y;
        ...
        int family;
public:
    model_dlm_slope(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dlm_slope_namespace::model_dlm_slope";
        ...
        try {
            ...
            validate_non_negative_index("beta0", "K", K);
            num_params_r__ += K;
            current_statement_begin__ = 14;
            validate_non_negative_index("pro_dev", "K", K);
            validate_non_negative_index("pro_dev", "(N - 1)", (N - 1));
            num_params_r__ += (K * (N - 1));
            current_statement_begin__ = 15;
            validate_non_negative_index("sigma_process", "K", K);
            num_params_r__ += (1 * K);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("beta0", "K", K);
        context__.validate_dims("parameter initialization", "beta0", "vector_d", context__.to_vec(K));
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta0(K);
        size_t beta0_j_1_max__ = K;
        ...
        validate_non_negative_index("pro_dev", "K", K);
        validate_non_negative_index("pro_dev", "(N - 1)", (N - 1));
        context__.validate_dims("parameter initialization", "pro_dev", "vector_d", context__.to_vec((N - 1),K));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > pro_dev((N - 1), Eigen::Matrix<double, Eigen::Dynamic, 1>(K));
        size_t pro_dev_j_1_max__ = K;
        ...
        pos__ = 0U;
        validate_non_negative_index("sigma_process", "K", K);
        context__.validate_dims("parameter initialization", "sigma_process", "double", context__.to_vec(K));
        std::vector<double> sigma_process(K, double(0));
        size_t sigma_process_k_0_max__ = K;
        for (size_t k_0__ = 0; k_0__ < sigma_process_k_0_max__; ++k_0__) {
            sigma_process[k_0__] = vals_r__[pos__++];
        }
        size_t sigma_process_i_0_max__ = K;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                beta0 = in__.vector_constrain(K, lp__);
            else
                beta0 = in__.vector_constrain(K);
            current_statement_begin__ = 14;
            ...
            for (size_t d_0__ = 0; d_0__ < pro_dev_d_0_max__; ++d_0__) {
                if (jacobian__)
                    pro_dev.push_back(in__.vector_constrain(K, lp__));
                else
                    pro_dev.push_back(in__.vector_constrain(K));
            }
            current_statement_begin__ = 15;
            std::vector<local_scalar_t__> sigma_process;
            size_t sigma_process_d_0_max__ = K;
            ...
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > beta(N, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(K));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(pred, 
                            ...
                            (multiply(get_base1(x, i, "x", 1), get_base1(beta, i, "beta", 1)) + x0), 
            ...
            for (int k = 1; k <= K; ++k) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(beta0, k, "beta0", 1), 0, 1));
                current_statement_begin__ = 38;
                lp_accum__.add(cauchy_log<propto__>(get_base1(sigma_process, k, "sigma_process", 1), 0, 5));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_dlm_slope_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double x0 = in__.scalar_constrain();
        vars__.push_back(x0);
        Eigen::Matrix<double, Eigen::Dynamic, 1> beta0 = in__.vector_constrain(K);
        size_t beta0_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < beta0_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            validate_non_negative_index("beta", "K", K);
            validate_non_negative_index("beta", "N", N);
            std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > beta(N, Eigen::Matrix<double, Eigen::Dynamic, 1>(K));
            stan::math::initialize(beta, DUMMY_VAR__);
            stan::math::fill(beta, DUMMY_VAR__);
            ...
            if (as_bool(logical_eq(family, 1))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                ...
                                normal_log(get_base1(y, n, "y", 1), get_base1(pred, n, "pred", 1), sigma_obs), 
            ...
            if (as_bool(logical_eq(family, 2))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                bernoulli_log(get_base1(y_int, n, "y_int", 1), inv_logit(get_base1(pred, n, "pred", 1))), 
                                "assigning variable log_lik");
                }
            }
            ...
            if (as_bool(logical_eq(family, 3))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                poisson_log(get_base1(y_int, n, "y_int", 1), stan::math::exp(get_base1(pred, n, "pred", 1))), 
                                "assigning variable log_lik");
                }
            }
            ...
            if (as_bool(logical_eq(family, 4))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                gamma_log(get_base1(y, n, "y", 1), sigma_obs, (sigma_obs / stan::math::exp(get_base1(pred, n, "pred", 1)))), 
                                "assigning variable log_lik");
                }
            }
            ...
            if (as_bool(logical_eq(family, 5))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                lognormal_log(get_base1(y, n, "y", 1), get_base1(pred, n, "pred", 1), sigma_obs), 
                                "assigning variable log_lik");
                }
            }
...
typedef model_dlm_slope_namespace::model_dlm_slope stan_model;
#ifndef USING_R

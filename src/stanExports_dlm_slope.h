...
namespace model_dlm_slope_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 96> locations_array__ =
  {" (found before start of program)",
  " (in 'dlm_slope', line 13, column 2 to column 10)",
  " (in 'dlm_slope', line 14, column 2 to column 18)",
  " (in 'dlm_slope', line 15, column 2 to column 25)",
  " (in 'dlm_slope', line 16, column 2 to column 33)",
  " (in 'dlm_slope', line 17, column 2 to column 26)",
  " (in 'dlm_slope', line 18, column 2 to column 27)",
  " (in 'dlm_slope', line 21, column 2 to column 17)",
  " (in 'dlm_slope', line 22, column 2 to column 20)",
  " (in 'dlm_slope', line 77, column 2 to column 24)",
  " (in 'dlm_slope', line 24, column 3 to column 24)",
  " (in 'dlm_slope', line 26, column 4 to column 62)",
  " (in 'dlm_slope', line 25, column 17 to line 27, column 4)",
  " (in 'dlm_slope', line 25, column 3 to line 27, column 4)",
  " (in 'dlm_slope', line 23, column 16 to line 28, column 3)",
  " (in 'dlm_slope', line 23, column 2 to line 28, column 3)",
  " (in 'dlm_slope', line 30, column 4 to column 34)",
  " (in 'dlm_slope', line 29, column 16 to line 31, column 3)",
  " (in 'dlm_slope', line 29, column 2 to line 31, column 3)",
  " (in 'dlm_slope', line 79, column 35 to column 97)",
  " (in 'dlm_slope', line 79, column 16 to column 97)",
  " (in 'dlm_slope', line 79, column 2 to column 97)",
  " (in 'dlm_slope', line 80, column 35 to column 104)",
  " (in 'dlm_slope', line 80, column 16 to column 104)",
  " (in 'dlm_slope', line 80, column 2 to column 104)",
  " (in 'dlm_slope', line 81, column 35 to column 96)",
  " (in 'dlm_slope', line 81, column 16 to column 96)",
  " (in 'dlm_slope', line 81, column 2 to column 96)",
  " (in 'dlm_slope', line 82, column 35 to column 114)",
  " (in 'dlm_slope', line 82, column 16 to column 114)",
  " (in 'dlm_slope', line 82, column 2 to column 114)",
  " (in 'dlm_slope', line 83, column 35 to column 100)",
  " (in 'dlm_slope', line 83, column 16 to column 100)",
  " (in 'dlm_slope', line 83, column 2 to column 100)",
  " (in 'dlm_slope', line 34, column 2 to column 20)",
  " (in 'dlm_slope', line 35, column 2 to column 31)",
  " (in 'dlm_slope', line 37, column 4 to column 26)",
  " (in 'dlm_slope', line 36, column 16 to line 38, column 3)",
  " (in 'dlm_slope', line 36, column 2 to line 38, column 3)",
  " (in 'dlm_slope', line 41, column 4 to column 27)",
  " (in 'dlm_slope', line 42, column 4 to column 40)",
  " (in 'dlm_slope', line 46, column 6 to column 39)",
  " (in 'dlm_slope', line 45, column 11 to line 47, column 5)",
  " (in 'dlm_slope', line 44, column 6 to column 32)",
  " (in 'dlm_slope', line 43, column 20 to line 45, column 5)",
  " (in 'dlm_slope', line 43, column 4 to line 47, column 5)",
  " (in 'dlm_slope', line 40, column 16 to line 48, column 3)",
  " (in 'dlm_slope', line 40, column 2 to line 48, column 3)",
  " (in 'dlm_slope', line 52, column 6 to column 50)",
  " (in 'dlm_slope', line 50, column 24 to line 53, column 5)",
  " (in 'dlm_slope', line 50, column 4 to line 53, column 5)",
  " (in 'dlm_slope', line 49, column 16 to line 54, column 3)",
  " (in 'dlm_slope', line 49, column 2 to line 54, column 3)",
  " (in 'dlm_slope', line 57, column 6 to column 52)",
  " (in 'dlm_slope', line 56, column 24 to line 58, column 5)",
  " (in 'dlm_slope', line 56, column 4 to line 58, column 5)",
  " (in 'dlm_slope', line 55, column 16 to line 59, column 3)",
  " (in 'dlm_slope', line 55, column 2 to line 59, column 3)",
  " (in 'dlm_slope', line 62, column 6 to column 48)",
  " (in 'dlm_slope', line 61, column 24 to line 63, column 5)",
  " (in 'dlm_slope', line 61, column 4 to line 63, column 5)",
  " (in 'dlm_slope', line 60, column 16 to line 64, column 3)",
  " (in 'dlm_slope', line 60, column 2 to line 64, column 3)",
  " (in 'dlm_slope', line 67, column 6 to column 67)",
  " (in 'dlm_slope', line 66, column 24 to line 68, column 5)",
  " (in 'dlm_slope', line 66, column 4 to line 68, column 5)",
  " (in 'dlm_slope', line 65, column 16 to line 69, column 3)",
  " (in 'dlm_slope', line 65, column 2 to line 69, column 3)",
  " (in 'dlm_slope', line 72, column 6 to column 53)",
  " (in 'dlm_slope', line 71, column 24 to line 73, column 5)",
  " (in 'dlm_slope', line 71, column 4 to line 73, column 5)",
  " (in 'dlm_slope', line 70, column 16 to line 74, column 3)",
  " (in 'dlm_slope', line 70, column 2 to line 74, column 3)",
  " (in 'dlm_slope', line 2, column 2 to column 17)",
  " (in 'dlm_slope', line 3, column 2 to column 21)",
  " (in 'dlm_slope', line 4, column 9 to column 14)",
  " (in 'dlm_slope', line 4, column 2 to column 18)",
  " (in 'dlm_slope', line 5, column 2 to column 17)",
  " (in 'dlm_slope', line 6, column 9 to column 10)",
  " (in 'dlm_slope', line 6, column 12 to column 13)",
  " (in 'dlm_slope', line 6, column 2 to column 17)",
  " (in 'dlm_slope', line 7, column 12 to column 17)",
  " (in 'dlm_slope', line 7, column 2 to column 19)",
  " (in 'dlm_slope', line 8, column 15 to column 22)",
  " (in 'dlm_slope', line 8, column 2 to column 24)",
  " (in 'dlm_slope', line 9, column 2 to column 13)",
  " (in 'dlm_slope', line 10, column 2 to column 22)",
  " (in 'dlm_slope', line 14, column 9 to column 10)",
  " (in 'dlm_slope', line 15, column 20 to column 23)",
  " (in 'dlm_slope', line 15, column 9 to column 10)",
  " (in 'dlm_slope', line 16, column 30 to column 31)",
  " (in 'dlm_slope', line 18, column 19 to column 25)",
  " (in 'dlm_slope', line 21, column 9 to column 10)",
  " (in 'dlm_slope', line 22, column 17 to column 18)",
  " (in 'dlm_slope', line 22, column 9 to column 10)",
  " (in 'dlm_slope', line 77, column 9 to column 14)"};
#include <stan_meta_header.hpp>
class model_dlm_slope final : public model_base_crtp<model_dlm_slope> {
private:
  int N;
  int n_pos;
...
public:
  ~model_dlm_slope() {}
  model_dlm_slope(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_dlm_slope_namespace::model_dlm_slope";
    // suppress unused var warning
    (void) function__;
    ...
    try {
      ...
      stan::math::validate_non_negative_index("pro_dev", "K", K);
      current_statement__ = 90;
      stan::math::validate_non_negative_index("sigma_process", "K", K);
    ...
    num_params_r__ = 1 + K + (pro_dev_1dim__ * K) + K + 1 + est_nu;
  }
  inline std::string model_name() const final {
    return "model_dlm_slope";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_dlm_slope_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      beta0 = in__.template read<Eigen::Matrix<local_scalar_t__,-1,1>>(K);
        ...
        for (int i = 2; i <= N; ++i) {
          ...
          stan::model::assign(beta,
            (stan::model::rvalue(beta, "beta",
               stan::model::index_uni((i - 1)), stan::model::index_uni(k)) +
      ...
      for (int i = 1; i <= N; ++i) {
        ...
        stan::model::assign(pred,
          ...
          x0), "assigning variable pred", stan::model::index_uni(i));
      }
      {
        ...
        for (int k = 1; k <= K; ++k) {
          ...
          lp_accum__.add(stan::math::student_t_lpdf<propto__>(
                           stan::model::rvalue(sigma_process,
                             "sigma_process", stan::model::index_uni(k)), 3,
                           0, 2));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_dlm_slope_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"x0", "beta0", "pro_dev",
                "sigma_process", "sigma_obs", "nu"};
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"pred", "beta"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"x0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta0\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"pro_dev\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(pro_dev_1dim__) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"sigma_process\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(K) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"sigma_obs\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(est_nu) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"pred\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"transformed_parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_pos) + "},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((1 + K) + (pro_dev_1dim__ * K)) + K) + 1)
      + est_nu);
...
using stan_model = model_dlm_slope_namespace::model_dlm_slope;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_dlm_slope_namespace::profiles__;
}
#endif
#endif

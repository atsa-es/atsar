...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ss_ar");
    reader.add_event(86, 84, "end", "model_ss_ar");
    return reader;
}
#include <stan_meta_header.hpp>
class model_ss_ar
  : public stan::model::model_base_crtp<model_ss_ar> {
private:
        int N;
        int n_pos;
        vector_d y;
        ...
        int family;
public:
    model_ss_ar(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ss_ar_namespace::model_ss_ar";
        ...
        try {
            ...
            for (int i = 2; i <= N; ++i) {
                ...
                stan::model::assign(pred, 
                            ...
                            ((temp + (phi * (get_base1(pred, (i - 1), "pred", 1) - temp))) + (sigma_process * get_base1(pro_dev, (i - 1), "pro_dev", 1))), 
                            "assigning variable pred");
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ss_ar_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_ss_ar_namespace::model_ss_ar stan_model;
#ifndef USING_R

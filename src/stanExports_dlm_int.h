...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_dlm_int");
    reader.add_event(68, 66, "end", "model_dlm_int");
    return reader;
}
#include <stan_meta_header.hpp>
class model_dlm_int
  : public stan::model::model_base_crtp<model_dlm_int> {
private:
        int N;
        int n_pos;
        vector_d y;
        ...
        int family;
public:
    model_dlm_int(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_dlm_int_namespace::model_dlm_int";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> intercept(N);
            ...
            stan::math::assign(pred, add(multiply(x, beta), intercept));
            ...
            for (size_t j_1__ = 0; j_1__ < intercept_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(intercept(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: intercept" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable intercept: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            // model body
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_dlm_int_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_dlm_int_namespace::model_dlm_int stan_model;
#ifndef USING_R

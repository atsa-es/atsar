...
namespace model_ar_drift_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ar_drift");
    reader.add_event(30, 28, "end", "model_ar_drift");
    return reader;
}
#include <stan_meta_header.hpp>
class model_ar_drift
  : public stan::model::model_base_crtp<model_ar_drift> {
private:
        int N;
        std::vector<double> y;
        int P;
public:
    model_ar_drift(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ar_drift_namespace::model_ar_drift";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ar_drift_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_ar_drift_namespace::model_ar_drift stan_model;
#ifndef USING_R

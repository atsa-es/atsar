...
namespace model_rw_drift_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_rw_drift");
    reader.add_event(27, 25, "end", "model_rw_drift");
    return reader;
}
#include <stan_meta_header.hpp>
class model_rw_drift
  : public stan::model::model_base_crtp<model_rw_drift> {
private:
        int N;
        std::vector<double> y;
public:
    model_rw_drift(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_rw_drift_namespace::model_rw_drift";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_rw_drift_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_rw_drift_namespace::model_rw_drift stan_model;
#ifndef USING_R

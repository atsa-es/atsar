...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ma");
    reader.add_event(41, 39, "end", "model_ma");
    return reader;
}
#include <stan_meta_header.hpp>
class model_ma
  : public stan::model::model_base_crtp<model_ma> {
private:
        int Q;
        int N;
        vector_d y;
        int est_nu;
public:
    model_ma(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ma_namespace::model_ma";
        ...
        try {
            ...
            pos__ = 0;
            N = vals_i__[pos__++];
            check_greater_or_equal(function__, "N", N, 3);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("theta", "Q", Q);
        context__.validate_dims("parameter initialization", "theta", "vector_d", context__.to_vec(Q));
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                theta = in__.vector_constrain(Q, lp__);
            else
                theta = in__.vector_constrain(Q);
            current_statement_begin__ = 11;
            ...
            for (int t = 1; t <= N; ++t) {
                ...
                for (int q = 1; q <= std::min((t - 1), Q); ++q) {
                    ...
                    stan::model::assign(epsilon, 
                                stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                (get_base1(epsilon, t, "epsilon", 1) - (get_base1(theta, q, "theta", 1) * get_base1(epsilon, (t - q), "epsilon", 1))), 
                                "assigning variable epsilon");
                }
            }
            ...
            for (int t = 1; t <= N; ++t) {
                ...
                for (int q = 1; q <= std::min((t - 1), Q); ++q) {
                    ...
                    stan::model::assign(pred, 
                                stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                (get_base1(pred, t, "pred", 1) + (get_base1(theta, q, "theta", 1) * get_base1(epsilon, (t - q), "epsilon", 1))), 
                                "assigning variable pred");
                }
            }
            ...
            if (as_bool(logical_eq(est_nu, 0))) {
                ...
                lp_accum__.add(student_t_log<propto__>(y, nu, pred, sigma));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ma_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> theta = in__.vector_constrain(Q);
        size_t theta_j_1_max__ = Q;
        for (size_t j_1__ = 0; j_1__ < theta_j_1_max__; ++j_1__) {
...
typedef model_ma_namespace::model_ma stan_model;
#ifndef USING_R

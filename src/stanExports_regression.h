...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_regression");
    reader.add_event(36, 34, "end", "model_regression");
    return reader;
}
#include <stan_meta_header.hpp>
class model_regression
  : public stan::model::model_base_crtp<model_regression> {
private:
        int N;
        int K;
        matrix_d x;
        ...
        int family;
public:
    model_regression(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_regression_namespace::model_regression";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(family, 4))) {
                current_statement_begin__ = 23;
                lp_accum__.add(gamma_log<propto__>(y, sigma, elt_divide(sigma, stan::math::exp(pred))));
            }
            current_statement_begin__ = 24;
            if (as_bool(logical_eq(family, 5))) {
                current_statement_begin__ = 24;
                lp_accum__.add(lognormal_log<propto__>(y, pred, sigma));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_regression_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            if (as_bool(logical_eq(family, 4))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                gamma_log(get_base1(y, n, "y", 1), sigma, (sigma / stan::math::exp(get_base1(pred, n, "pred", 1)))), 
                                "assigning variable log_lik");
                }
            }
            ...
            if (as_bool(logical_eq(family, 5))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                lognormal_log(get_base1(y, n, "y", 1), get_base1(pred, n, "pred", 1), sigma), 
                                "assigning variable log_lik");
                }
            }
...
typedef model_regression_namespace::model_regression stan_model;
#ifndef USING_R

...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_regression_cor");
    reader.add_event(46, 44, "end", "model_regression_cor");
    return reader;
}
#include <stan_meta_header.hpp>
class model_regression_cor
  : public stan::model::model_base_crtp<model_regression_cor> {
private:
        int N;
        int K;
        matrix_d x;
        ...
        int family;
public:
    model_regression_cor(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_regression_cor_namespace::model_regression_cor";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            local_scalar_t__ sigma_cor;
            (void) sigma_cor;  // dummy to suppress unused var warning
            stan::math::initialize(sigma_cor, DUMMY_VAR__);
            stan::math::fill(sigma_cor, DUMMY_VAR__);
            // transformed parameters block statements
            current_statement_begin__ = 18;
            stan::model::assign(pred, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        multiply(get_base1(x, 1, "x", 1), beta), 
                        "assigning variable pred");
            current_statement_begin__ = 19;
            stan::model::assign(epsilon, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        (get_base1(y, 1, "y", 1) - get_base1(pred, 1, "pred", 1)), 
            ...
            for (int i = 2; i <= N; ++i) {
                ...
                stan::model::assign(pred, 
                            ...
                            multiply(get_base1(x, i, "x", 1), beta), 
                            "assigning variable pred");
                current_statement_begin__ = 22;
                stan::model::assign(epsilon, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            ((get_base1(y, i, "y", 1) - get_base1(pred, i, "pred", 1)) - (phi * get_base1(epsilon, (i - 1), "epsilon", 1))), 
                            "assigning variable epsilon");
            }
            current_statement_begin__ = 24;
            stan::math::assign(sigma_cor, stan::math::sqrt(((sigma * sigma) * (1 - (phi * phi)))));
            ...
            current_statement_begin__ = 17;
            if (stan::math::is_uninitialized(sigma_cor)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: sigma_cor";
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable sigma_cor: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            // model body
            ...
            if (as_bool(logical_eq(family, 1))) {
                current_statement_begin__ = 30;
                lp_accum__.add(normal_log<propto__>(y, pred, sigma_cor));
            }
            current_statement_begin__ = 31;
            if (as_bool(logical_eq(family, 2))) {
                current_statement_begin__ = 31;
                lp_accum__.add(bernoulli_logit_log<propto__>(y_int, pred));
            }
            current_statement_begin__ = 32;
            if (as_bool(logical_eq(family, 3))) {
                current_statement_begin__ = 32;
                lp_accum__.add(poisson_log_log<propto__>(y_int, pred));
            }
            current_statement_begin__ = 33;
            if (as_bool(logical_eq(family, 4))) {
                current_statement_begin__ = 33;
                lp_accum__.add(gamma_log<propto__>(y, sigma_cor, elt_divide(sigma_cor, stan::math::exp(pred))));
            }
            current_statement_begin__ = 34;
            if (as_bool(logical_eq(family, 5))) {
                current_statement_begin__ = 34;
                lp_accum__.add(lognormal_log<propto__>(y, pred, sigma_cor));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_regression_cor_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            if (as_bool(logical_eq(family, 1))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                ...
                                normal_log(get_base1(y, n, "y", 1), get_base1(pred, n, "pred", 1), sigma_cor), 
            ...
            if (as_bool(logical_eq(family, 4))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                gamma_log(get_base1(y, n, "y", 1), sigma_cor, (sigma_cor / stan::math::exp(get_base1(pred, n, "pred", 1)))), 
                                "assigning variable log_lik");
                }
            }
            ...
            if (as_bool(logical_eq(family, 5))) {
                ...
                for (int n = 1; n <= N; ++n) {
                    ...
                    stan::model::assign(log_lik, 
                                stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                                lognormal_log(get_base1(y, n, "y", 1), get_base1(pred, n, "pred", 1), sigma_cor), 
                                "assigning variable log_lik");
                }
            }
...
typedef model_regression_cor_namespace::model_regression_cor stan_model;
#ifndef USING_R

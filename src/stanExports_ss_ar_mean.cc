...
#include "stanExports_ss_ar_mean.h"

RCPP_MODULE(stan_fit4ss_ar_mean_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_ss_ar_mean")

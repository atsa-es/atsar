...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(46, 44, "end", "model_ar");
    return reader;
}
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(est_nu, 0))) {
                ...
                lp_accum__.add(student_t_log<propto__>(stan::model::rvalue(y, stan::model::cons_list(stan::model::index_min_max(P, N), stan::model::nil_index_list()), "y"), nu, stan::model::rvalue(pred, stan::model::cons_list(stan::model::index_min_max(P, N), stan::model::nil_index_list()), "pred"), sigma));
            }
